...
export const gamesPT_BR: Game[] = [
  {
    ...
    images: [
      "src/assets/espada_do_abismo/Espadadoabismo1.png",
      "src/assets/espada_do_abismo/Espadadoabismo2.png",
      "src/assets/espada_do_abismo/Espadadoabismo3.png",
      "src/assets/espada_do_abismo/Espadadoabismo4.png",
      "src/assets/espada_do_abismo/Espadadoabismo5.png",
      "src/assets/espada_do_abismo/Espadadoabismo6.png",
    ],
    ...
    characters: [
      {
        ...
        type: "Cavaleiro",
        age: 21,
        slug: "src/assets/espada_do_abismo/lucius1.png",
      ...
      },
      {
        ...
        type: "Ladina",
        age: 20,
        slug: "src/assets/espada_do_abismo/sherry1.png",
      ...
      },
      {
        ...
        type: "Mago",
        age: 28,
        slug: "src/assets/espada_do_abismo/kain1.png",
